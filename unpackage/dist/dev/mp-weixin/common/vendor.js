...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__8241DBE",
    appName: "MagazineReader",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  ...
  {
    path: "pages/myNote/myNote",
    style: {
      navigationBarTitleText: "My Note"
    }
  },
  {
