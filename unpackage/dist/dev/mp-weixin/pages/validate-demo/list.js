...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "15a9b8ea-2-" + i0 + "-" + i1 + "," + ("15a9b8ea-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "15a9b8ea-1-" + i0 + ",15a9b8ea-0"
      } : {}, {
        c: data,
        g: loading
      }, loading ? {
        h: "15a9b8ea-3-" + i0 + ",15a9b8ea-0",
        i: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "15a9b8ea-0"),
    c: common_vendor.p({
    ...
    d: common_vendor.sr("fab", "15a9b8ea-4"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/nico/Documents/HBuilderProjects/MagazineReader/pages/validate-demo/list.vue"]]);
