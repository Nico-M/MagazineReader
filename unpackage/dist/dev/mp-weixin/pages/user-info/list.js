...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "0e1e3315-2-" + i0 + "-" + i1 + "," + ("0e1e3315-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "0e1e3315-1-" + i0 + ",0e1e3315-0"
      } : {}, {
        c: data,
        g: "0e1e3315-3-" + i0 + ",0e1e3315-0",
        h: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "0e1e3315-0"),
    c: common_vendor.p({
    ...
    d: common_vendor.sr("fab", "0e1e3315-4"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/nico/Documents/HBuilderProjects/MagazineReader/pages/user-info/list.vue"]]);
