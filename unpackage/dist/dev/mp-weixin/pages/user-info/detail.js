  ...
  return {
    a: common_vendor.w(({
      ...
      return common_vendor.e({
        ...
        m: "2a6764f0-3-" + i0 + ",2a6764f0-0",
        n: common_vendor.p({
          href: "mailto:" + data.email,
          text: data.email
        }),
        o: "2a6764f0-4-" + i0 + ",2a6764f0-0",
        p: common_vendor.p({
          href: data.url,
          download: data.url,
          text: data.url
    ...
    b: common_vendor.sr("udb", "2a6764f0-0"),
    c: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/nico/Documents/HBuilderProjects/MagazineReader/pages/user-info/detail.vue"]]);
