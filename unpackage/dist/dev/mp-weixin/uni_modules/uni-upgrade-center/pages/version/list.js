...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    n: common_vendor.w(({
      ...
      return {
        a: "41be4b78-4-" + i0 + "," + ("41be4b78-3-" + i0),
        b: "41be4b78-5-" + i0 + "," + ("41be4b78-3-" + i0),
        c: "41be4b78-6-" + i0 + "," + ("41be4b78-3-" + i0),
        d: "41be4b78-7-" + i0 + "," + ("41be4b78-3-" + i0),
        e: "41be4b78-8-" + i0 + "," + ("41be4b78-3-" + i0),
        f: "41be4b78-9-" + i0 + "," + ("41be4b78-3-" + i0),
        g: "41be4b78-10-" + i0 + "," + ("41be4b78-3-" + i0),
        h: "41be4b78-11-" + i0 + "," + ("41be4b78-3-" + i0),
        i: "41be4b78-3-" + i0 + "," + ("41be4b78-2-" + i0),
        j: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.appid),
            b: "41be4b78-13-" + i0 + "-" + i1 + "," + ("41be4b78-12-" + i0 + "-" + i1),
            c: common_vendor.t(item.title || "-"),
            d: "41be4b78-14-" + i0 + "-" + i1 + "," + ("41be4b78-12-" + i0 + "-" + i1),
            ...
            i: "41be4b78-15-" + i0 + "-" + i1 + "," + ("41be4b78-12-" + i0 + "-" + i1),
            j: "41be4b78-17-" + i0 + "-" + i1 + "," + ("41be4b78-16-" + i0 + "-" + i1),
            k: common_vendor.p({
            ...
            l: "41be4b78-16-" + i0 + "-" + i1 + "," + ("41be4b78-12-" + i0 + "-" + i1),
            m: common_vendor.t(item.version),
            n: "41be4b78-18-" + i0 + "-" + i1 + "," + ("41be4b78-12-" + i0 + "-" + i1),
            o: common_vendor.t(item.stable_publish == true ? "已上线" : "已下线"),
            p: "41be4b78-19-" + i0 + "-" + i1 + "," + ("41be4b78-12-" + i0 + "-" + i1),
            q: "41be4b78-21-" + i0 + "-" + i1 + "," + ("41be4b78-20-" + i0 + "-" + i1),
            r: common_vendor.p({
              format: "yyyy-MM-dd hh:mm:ss",
              date: item.create_date,
              threshold: [0, 0]
            }),
            s: "41be4b78-20-" + i0 + "-" + i1 + "," + ("41be4b78-12-" + i0 + "-" + i1),
            t: common_vendor.o(($event) => $options.navigateTo("./detail?id=" + item._id, false), index),
            v: "41be4b78-22-" + i0 + "-" + i1 + "," + ("41be4b78-12-" + i0 + "-" + i1),
            w: index,
            x: "41be4b78-12-" + i0 + "-" + i1 + "," + ("41be4b78-2-" + i0),
            y: common_vendor.p({
              disabled: item.stable_publish
            })
          };
        }),
        k: "41be4b78-2-" + i0 + ",41be4b78-1",
        l: common_vendor.p({
          loading,
    ...
    H: common_vendor.sr("udb", "41be4b78-1"),
    I: common_vendor.p({
